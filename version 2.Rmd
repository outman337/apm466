...
for (i in 1:9){
  X_1[i] <- log(ytm[1+i][2,]/ytm[1][2,])
  X_2[i] <- log(ytm[1+i][4,]/ytm[1][4,])
  X_3[i] <- log(ytm[1+i][6,]/ytm[1][6,])
  X_4[i] <- log(ytm[1+i][8,]/ytm[1][8,])
  X_5[i] <- log(ytm[1+i][10,]/ytm[1][10,])
}
ytm_matrix <- t(matrix(c(X_1,X_2,X_3,X_4,X_5), ncol = 5))
ytm_matrix <- cov(t(ytm_matrix))
ytm_matrix
```
...
Y_4 = rep(0,4)
for (i in 1:9){
  Y_1[i] <- log(forward[1+i][1,]/forward[1][1,])
  Y_2[i] <- log(forward[1+i][2,]/forward[1][2,])
  Y_3[i] <- log(forward[1+i][3,]/forward[1][3,])
  Y_4[i] <- log(forward[1+i][4,]/forward[1][4,])
}
for_matrix <- t(matrix(c(Y_1,Y_2,Y_3,Y_4), ncol = 4))
for_matrix <- cov(t(for_matrix))
for_matrix
```
